...
import { IAccountActivateParams, IAccountApproveParams } from '@user/interfaces/user.interface'
...
export class ApproveAccountCreation {
	public async read(req: Request, res: Response): Promise<void> {
		...
		emailQueue.addEmailJob('sendEmail', { template, receiverEmail: existingUser.email, subject: 'Account approved successfully 400024' })
