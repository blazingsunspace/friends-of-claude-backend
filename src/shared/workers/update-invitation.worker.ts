...
const log: Logger = config.createLogger('invitationWorker')
let worker: Worker

import jobProcessor from './jobs/UpdateInvitationToDBWorker'
export async function updateInvitationToDBWorker(jobName: string): Promise<void> {
